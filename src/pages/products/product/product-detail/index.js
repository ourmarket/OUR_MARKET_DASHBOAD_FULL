...
function ProductDetail() {
  ...
  const { data: totalProductSell, isLoading: l3, error: e3 } = useGetProductsTotalByIDQuery(id);
  const { data: totalProductSellLast30Days, isLoading: l4, error: e4 } = 
          ...
          <Grid item xs={12} lg={12}>
            <Card sx={{ overflow: "visible" }}>
              ...
              <MDBox px={2} mt={1}>
                ...
                >
                  <Tab label="Información General" sx={{ fontWeight: "bold" }} />
                  <Tab label="Configuración y Edición" sx={{ fontWeight: "bold" }} />
                </Tabs>
              ...
              <MDBox pb={3} px={3}>
                ...
                {!isLoading && !hasError && (
                  <>
                    {tabIndex === 0 && productById && totalProductSell && totalProductSellLast30Days && (
                    ...
                    {tabIndex === 1 && categoryData && productById && (
                      <MDBox animate={{ opacity: 1 }}>
                        <EditProductoForm
